## Background
As we know, in python, `0.2 == 0.3 - 0.1` returns `False`, so we should know that it's difficult to store some decimals in computer in binary (some numbers will actually cyclic numbers and python will round thema).
## floats in binary
$$\begin{align}
